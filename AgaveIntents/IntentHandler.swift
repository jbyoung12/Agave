...
//  AgaveIntents
//
//  Created by Oscar Hong on 10/14/18.
...
class IntentHandler: INExtension{
    ...
    override func handler(for intent: INIntent) -> Any {
        ...
        guard intent is CreateBookmarkIntent else {
    ...
    func handle(intent: CreateBookmarkIntent, completion: @escaping (CreateBookmarkIntentResponse) -> Void) {
...
//        let db = Firestore.firestore()
        ...
        /*
//       let podcastUsers = db.collection("podcasts").document((Player.app.podcastId)!).collection("users")
